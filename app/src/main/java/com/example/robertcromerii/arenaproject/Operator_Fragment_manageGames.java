...
public class Operator_Fragment_manageGames extends Fragment
{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        view.findViewById(R.id.operator_manageGamesButton).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                Toast.makeText(getActivity(), "You Are inside Manage Games Operator Fragement", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
